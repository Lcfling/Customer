						...
						{{range $k,$v := .topMessages}}
                            <li>
                                <a href="{{$v.Url}}" class="js-msg-status" data-id="{{$v.Id}}">
                                    <span class="thumb"><img src="{{$v.Userid}}"></span>
                                        <span class="desc">
                                          <span class="name">{{$v.Userid}}<!--span class="badge badge-success">new</span--></span>
                                          <span class="msg">{{ $v.Type}}了{{$v.Subtype}}&nbsp;&nbsp;{{$v.Title}}</span>
                                        </span>
                                </a>
                            </li>
							 {{else}}
